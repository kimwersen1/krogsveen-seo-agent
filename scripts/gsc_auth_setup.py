...
def main() -> None:
    parser = argparse.ArgumentParser(description="Engangs OAuth-samtykke for GSC-tilgang")
    ...
    print("Åpner nettleseren din — logg inn med kontoen som har tilgang til Search Console.\n")
